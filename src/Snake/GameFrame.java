...
public class GameFrame {
    ...
    private final int fWidth = 450;        //窗口宽
    private final int fHeight = 450;        //窗口高
    private GameCanvas gc;        //贪吃蛇画布
    private OperationList ol;    //相关信息
    private Snake sk;
    private Food fd;
    ...
    public void frameinit() {
        ...
        //开始界面Panel
        StartPanel sp = new StartPanel(this).panelInit();
        //sp =sp.panelInit();
